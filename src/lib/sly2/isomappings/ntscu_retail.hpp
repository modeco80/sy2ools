...
BEGIN_NAME_MAPPING_TABLE(NtscU, Release)
	...
	NAME_BY_LBA(0x00125efc, 15648, VagEnglish, "e0_clockwerk_01_crm_1"),
	NAME_BY_LBA(0x00125f04, 52000, VagEnglish, "e0_clockwerk_02_sly_1"),
	NAME_BY_LBA(0x00125f1e, 66848, VagEnglish, "e0_clockwerk_03_crm_1"),
	NAME_BY_LBA(0x00125f3f, 44144, VagEnglish, "e0_clockwerk_04_sly_1"),
	NAME_BY_LBA(0x00125f55, 75056, VagEnglish, "e0_clockwerk_05_crm_1"),
	NAME_BY_LBA(0x00125f7a, 24112, VagEnglish, "e0_clockwerk_06_sly_1"),
	NAME_BY_LBA(0x00125f86, 17936, VagEnglish, "e0_clockwerk_07_crm_1"),
	NAME_BY_LBA(0x00125f8f, 92384, VagEnglish, "e0_clockwerk_08_nla_1"),
	NAME_BY_LBA(0x00125fbd, 14032, VagEnglish, "e0_clockwerk_09_sly_1"),
	NAME_BY_LBA(0x00125fc4, 90368, VagEnglish, "e0_clockwerk_10_crm_1"),
	NAME_BY_LBA(0x00125ff1, 36144, VagEnglish, "e0_clockwerk_11_nla_1"),
	NAME_BY_LBA(0x00126003, 46496, VagEnglish, "e0_clockwerk_12_crm_1"),
	NAME_BY_LBA(0x0012601a, 37360, VagEnglish, "e0_clockwerk_13_nla_1"),
	NAME_BY_LBA(0x0012602d, 24928, VagEnglish, "e0_clockwerk_14_crm_1"),
	NAME_BY_LBA(0x0012603a, 16144, VagEnglish, "e0_chase_taunt_01_crm_1"),
	NAME_BY_LBA(0x00126042, 13216, VagEnglish, "e0_chase_taunt_02_crm_1"),
	NAME_BY_LBA(0x00126049, 18192, VagEnglish, "e0_chase_taunt_03_crm_1"),
	NAME_BY_LBA(0x00126052, 9712, VagEnglish, "e0_chase_taunt_04_crm_1"),
	NAME_BY_LBA(0x00126057, 19808, VagEnglish, "e0_chase_taunt_05_crm_1"),
	NAME_BY_LBA(0x00126061, 40912, VagEnglish, "e0_chase_bail_02_mur_1"),
	NAME_BY_LBA(0x00126075, 27472, VagEnglish, "e0_chase_bail_03_sly_1"),
	NAME_BY_LBA(0x00126083, 22736, VagEnglish, "e0_chase_bail_04_bnt_1"),
	NAME_BY_LBA(0x0012608f, 34864, VagEnglish, "e0_chase_bail_05_sly_1"),
	NAME_BY_LBA(0x001260a1, 59056, VagEnglish, "e0_chase_bail_06_sly_1"),
	NAME_BY_LBA(0x001260be, 22912, VagEnglish, "e0_chase_bail_07_crm_1"),
	NAME_BY_LBA(0x001260ca, 19088, VagEnglish, "e0_chase_bail_08_sly_1"),
	NAME_BY_LBA(0x001260d4, 49520, VagEnglish, "e0_chase_bail_09_mur_radio_1"),
	NAME_BY_LBA(0x001260ed, 19808, VagEnglish, "e0_chase_bail_10_crm_1"),
